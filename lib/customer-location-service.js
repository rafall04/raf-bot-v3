...
const LOCATION_SOURCES = Object.freeze({
    ...
    ADMIN_WEB: "admin_web",
    // Teknisi lewat panel web — DIBEDAKAN dari `admin_web` karena keandalannya beda: teknisi biasanya
    // menandai sambil berdiri di depan rumah (sering dari GPS HP), admin menandai dari kantor lewat
    // koordinat/link yang dikirim orang lain. Tanpa pembedaan ini, titik dari dua situasi yang sangat
    // berbeda akan tampak sama saat nanti dinilai layak-tidaknya dipercaya.
    TEKNISI_WEB: "teknisi_web",
    IMPORT: "import"
});
