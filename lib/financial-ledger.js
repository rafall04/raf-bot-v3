...
function readJsonArray(filePath) {
    ...
    try {
        ...
        console.error(`[FIN_LEDGER] Sumber ${path.basename(filePath)} korup/invalid — domain ini di-skip sync:`, error.message);
        return [];
    }
}
...
function classifyLedgerCashflow(entry) {
    ...
    default:
        ...
        console.warn(`[LEDGER_UNKNOWN_DOMAIN] domain "${entry.domain}" belum diklasifikasikan di classifyLedgerCashflow — sementara dihitung ${direction === "credit" ? "PEMASUKAN" : "PENGELUARAN"}. Tambahkan ke switch.`);
        return direction === "credit"
