...
async function getOltData(config) {
    ...
    try {
        ...
        const [
            descRows, serialRows, modelRows, portRows, phaseRows, reasonRows,
        ...
        const { rxMap, txMap } = await fetchOpticsConcurrent(walkCfg, onlineKeys);
...
module.exports = {
    ...
    testConnection,
    matchIdentity,
    __test: { formatZteSerial, parseRxPower, parseTxPower, classifyStatus, extractIndex, OID, ZTE_OFFLINE_CAUSE },
};
