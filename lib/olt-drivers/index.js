...
/**
 * Auto-deteksi brand via SNMP sysObjectID (1.3.6.1.2.1.1.2.0): ambil enterprise number
 * lalu cocokkan ke driver.enterpriseOids. Fallback sysDescr (regex brand) lalu DEFAULT_BRAND.
 * @param {object} config {host, community/snmpCommunity, port/snmpPort, ...}
