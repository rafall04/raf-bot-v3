...
const FEATURE_FLAGS = [
    ...
    { key: "bulkApprovalJob", path: ["bulkApprovalJob", "enabled"], kategori: "Pembayaran", label: "Otorisasi Massal Tanpa Batas", desc: "Otorisasi seluruh pengajuan (bukan cuma 20) lewat pekerjaan latar — untuk WA & halaman web." },
...
module.exports = { FEATURE_FLAGS, flagByKey, getFlagEnabled, readFlags, applyFlag };
