...
function generateInvoiceHTML(invoiceData, customization = {}) {
    ...
    const perusahaan = {
        name: bersihkanPlaceholder((invoiceData.company && invoiceData.company.name) || '', ''),
        address: bersihkanPlaceholder((invoiceData.company && invoiceData.company.address) || '', ''),
        phone: bersihkanPlaceholder((invoiceData.company && invoiceData.company.phone) || '', ''),
        email: bersihkanPlaceholder((invoiceData.company && invoiceData.company.email) || '', ''),
        npwp: bersihkanPlaceholder((invoiceData.company && invoiceData.company.npwp) || '', ''),
    };
