...
function generateInvoiceHTML(invoiceData, customization = {}) {
    ...
    // Dipakai blok "Metode Pembayaran yang Diterima" di bawah, yang sekaligus
    // akhirnya menampilkan invoiceData.bankAccount — data itu sudah lama
    // disimpan di TIAP record invoice (lib/invoice-generator.js) tapi tak pernah
    // ditampilkan, jadi rekening yang diisi admin tak pernah sampai ke pelanggan.
    //
