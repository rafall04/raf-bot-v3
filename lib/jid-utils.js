/**
 * JID Utilities - Unified JID Normalization Module
 * 
 * Semua fungsi normalisasi JID di satu tempat untuk konsistensi dan maintainability.
 * Fungsi utama: normalizeJid - mengkonversi @lid ke format @s.whatsapp.net
 */
