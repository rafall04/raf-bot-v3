        ...
        async initializeBackgroundServices() {
            ...
            this.dbInitPromise.then(async () => {
                ...
                try {
                    ...
                    console.error("[MessageLog] Prune init gagal:", err.message);
                }
                ...
                try {
                    ...
                    if (smartReport && typeof smartReport.pindaiDraftLaporanTertunda === "function") {
                        const jalankanPindai = () => {
                            smartReport
                                ...
                                .catch((e) => console.error("[MATI_DRAFT_SCAN] tick gagal:", e?.message));
                        };
                    ...
                    console.error("[MATI_DRAFT_SCAN] Failed to start:", err.message);
                }
                ...
                try {
                    ...
                    console.error("[OTORISASI_JOB] Failed to start:", err.message);
                }
