 ...
 *          (label/affects/gatewayTarget/capacity), dan thresholds. Field WIRING (key/routingTable/
...
/**
 * Terapkan patch {targets?, services?, paths?, thresholds?} — validasi dulu SEMUA bagian,
