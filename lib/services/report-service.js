...
class ReportService extends BaseService {
    ...
    static async _sendReportNotifications(report, user, customerJid, primaryPhoneNumber, now) {
        ...
        // produksi tetap utuh.
        const { teks: mulaiKerja, teksRentang: rentangKerja } = waktuMulaiKerjaBerikutnya();
        const pesanKePelanggan = mulaiKerja
            ? confirmationMessage + renderResponseTemplate('report_service_luar_jam_kerja', { jamKerja: rentangKerja || mulaiKerja, waktuMulai: mulaiKerja })
            : confirmationMessage;
