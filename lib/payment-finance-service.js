 ...
 * MainFuncs: `applyPaymentStatusChange`, `applyFreeMonth`, `getPaymentPositionForPeriod`, `getPaymentStatusReadModel`, `syncUserPaidStatusForCurrentPeriod`, `getPaymentDiagnostics`, `withPaymentReadContext`.
...
async function getPaymentPositionForPeriod(user, periodMonth, periodYear, options = {}) {
    ...
    const paidByPayment = amountDue > 0 ? netPaid >= amountDue : netPaid > 0;
