 ...
 * MainFuncs: `buildSteeringOverview`, `buildSegmentMap`, `previewSegmentMove` (kendali per-SEGMEN,
 *            read/dry-run), `steerCustomer`, `poolEntryAction`, `setupSteeringRules`,
 *            `reconcileOnce`, `startCustomerSteeringReconciler`, `getSteeringConfig`.
