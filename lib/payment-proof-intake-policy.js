...
function classifyIncomingPhoto({
    ...
    // 4. Caption mengeluh → foto ini bukti KENDALA. Pengecualian: kalau pelanggan juga menyebut bayar
    //    DAN memang punya tagihan ("sdh tf tapi masih lemot"), dia sedang mengklaim bayar → biarkan
    //    admin yang menilai; bingkai "pembayaran" tidak menyesatkan karena dia sendiri yang menyebutnya.
    if (complaintHint && !(paymentHint && hasDue)) {
