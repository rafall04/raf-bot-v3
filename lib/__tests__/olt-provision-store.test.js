...
// Field inti yang diisi form registrasi (bukan default profil).
const CORE = { ponPort: '1/2/1', onuId: '16', sn: 'ZTEGD0337233', name: 'tester', pppoeUser: 'tester@vans', pppoePassword: 'rahasia' };
