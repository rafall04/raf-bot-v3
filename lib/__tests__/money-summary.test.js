...
describe("teks ringkasan", () => {
    ...
    test("template terdaftar di store dengan bentuk yang benar", () => {
        ...
        expect(t.be_ringkasan_uang.template).toContain("${mrr}");
        expect(t.be_ringkasan_uang.template).toContain("${tunggakan}");
        expect(t.be_ringkasan_uang.template).toContain("${sisa_bersih}");
    });
});
