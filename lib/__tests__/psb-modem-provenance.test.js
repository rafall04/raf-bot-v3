...
describe("pola tukar modem: baris pelanggan menunjuk modem LAIN", () => {
    ...
    test("modem yang MEMANG tercatat utk pelanggan itu → tetap DITAHAN untuk diverifikasi", () => {
        const hasil = classifyModemCandidate(
        ...
        expect(hasil.assignable).toBe(false);
        expect(hasil.butuhKonfirmasi).toBe(true);   // stiker yang memutuskan, bukan bot
    });
    ...
    test("lastInform TAK TERBACA → tetap ditahan (tak pernah lolos diam-diam)", () => {
