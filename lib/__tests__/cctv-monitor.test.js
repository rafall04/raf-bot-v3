...
function setup({ enabled = true, devices = [], confirmationMinutes = 1, cooldown = 30*60_000, notifyRecovery = true, massOutageThreshold = 0, massOutageAdminPhone = '', quietHoursEnabled = false, quietStart = '22:00', quietEnd = '06:00', coordinators = {}, seedIncidents = [] } = {}) {
    let nw = [];
    const sent = [];
