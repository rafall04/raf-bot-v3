...
const { parseUncfgOutput, parseOnuOccupancy, parseOnuDetail, parsePonPower, parseCardPonPorts, parseOnuTypeNames, parseProfileNames, parseVlanSummary, suggestOnuId, renderScript, validateVars, listPlaceholders } = provision.__test;
