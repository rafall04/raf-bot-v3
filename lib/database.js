                ...
                db.get("SELECT name FROM sqlite_master WHERE type='table' AND name='users'", (err, row) => {
                    ...
                    if (!row) {
                        ...
                        const createIndexesSql = [
                            ...
                            // JARING PENGAMAN DB (invariant "tiap pelanggan punya tanggal daftar").
                            // Tabel users LAMA (dibuat lib/migration-helper) ber-`created_at TEXT DEFAULT NULL`,
                            // BUKAN CURRENT_TIMESTAMP — dan SQLite TIDAK punya ALTER COLUMN untuk mengubah
                            // default kolom yang sudah ada. Trigger ini menambalnya: setiap INSERT yang
                            // meninggalkan created_at/updated_at kosong akan diisi otomatis. Sengaja di DB,
                            // bukan hanya di kode — karena terbukti kode BISA lupa (INSERT lama membuang kolom).
