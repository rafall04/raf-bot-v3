 ...
 * MainFuncs: `ensureTable`, `createRequest`, `listSchedules`, `getScheduleById`, `getScheduleSummary`, `setMarketing`, `STATUS`.
...
function ensureTable() {
    if (!_initPromise) {
        ...
        `).then(() => Promise.all([
            ...
            ensureColumn("marketing_status", "TEXT"),      // NULL(tak ada) | pending(terutang) | paid(dibayar—Fase 2)
            ensureColumn("marketing_paid_at", "TEXT")      // diisi saat dibayar (Fase 2)
