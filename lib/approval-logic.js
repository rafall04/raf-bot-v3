                        ...
                        if (invoiceData) {
                            ...
                            while (retryCount < maxRetries && !pdfResult) {
                                try {
                                    ...
                                    // Setelan tampilan lewat SATU perakit bersama.
                                    // Salinan lama di sini melewatkan `showDueDate` dan
                                    // `logoUrl`, sehingga PDF yang DIKIRIM ke pelanggan
                                    // lewat WhatsApp mengabaikan dua setelan yang dihormati
                                    // saat invoice yang sama dibuka di panel — dokumen
