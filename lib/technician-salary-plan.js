...
const { createPayrollDraft, getPayrollList } = require("./technician-finance-service");
 ...
 */
async function savePlans(items = []) {
    await ensureTable();
    ...
    return { ok: true, tersimpan: bersih.length, items: bersih };
}
