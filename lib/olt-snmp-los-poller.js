    ...
    async function pollOnce() {
        ...
        try {
            ...
            for (const device of devices) {
                ...
                let result;
                try {
                    // skipOptics: poller hanya butuh STATUS (LOS/online), bukan rx-power optik →
                    // lewati GET optik (driver ZTE) agar cycle cepat & ringan utk OLT tiap interval.
                    result = await driver.getOltData(buildConfig(device), { skipOptics: true });
                } catch (e) {
