...
const SYMPTOM_TOKENS = new Set([
    ...
    "lag", "lagg", "ngelag", "ngadat", "buffering", "ngebuffer", "loding", "muter", "rto",
...
const SYMPTOM_PHRASES = [
    ...
    "susah konek", "angel konek", "angel mlebu"
];
...
function getLooseIntentFromKeywords(message) {
    ...
    if (hasContext) {
        ...
        const matched = symptomToken || symptomPhrase || checkToken || troubleToken || troublePhrase;
        if (matched) {
