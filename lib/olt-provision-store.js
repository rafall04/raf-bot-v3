...
const PLACEHOLDER_DOC = [
    ...
    { key: 'vlanProfile', desc: 'Nama vlan-profile di OLT (untuk wan-ip mode pppoe)' },
...
// Gaya "wan-ip mode pppoe" — pola nyata di C320 VANS (verif live via
// `show onu running config`): service INET/HS, kredensial PPPoE lewat wan-ip host 1
// dengan vlan-profile yang sudah dibuat di OLT, WiFi di wifi_0/2.
const TEMPLATE_ROUTER_WANIP = [
    'conf t',
    'int gpon-olt_{{ponPort}}',
    'onu {{onuId}} type {{onuType}} sn {{sn}}',
    '!',
...
const DEFAULT_ONU_TYPES = [
    ...
    {
        id: 'zte-router-wanip',
        name: 'ZTE Router — wan-ip PPPoE (gaya C320 VANS)',
        brand: 'zte',
        notes: 'ONU router F609 dkk dengan PPPoE via "wan-ip 1 mode pppoe ... vlan-profile" (butuh vlan-profile sudah dibuat di OLT). Pola sesuai konfigurasi nyata C320 VANS: service INET + HS, WiFi wifi_0/2.',
        vars: {
            onuType: 'F609',
            tcontProfile: '1G',
            pppoeVlan: '300',
        ...
        scriptTemplate: TEMPLATE_ROUTER_WANIP,
        builtin: true,
    },
    {
        id: 'zte-bridge',
