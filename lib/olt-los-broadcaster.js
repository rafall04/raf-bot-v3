...
function createLosBroadcaster(deps = {}) {
        ...
        if (ncfg.enabled && ncfg.notifyOnRecovery !== false) {
            for (const rec of recs) {
                try {
                    ...
                    const custMsg = amankanTeksPelanggan(buildCustomerRecoveryMessage(a.customer, a, ncfg), a.customer);
     ...
     */
    function amankanTeksPelanggan(message, customer) {
        try {
    ...
    async function onCustomerNotify(mac) {
        ...
        const message = amankanTeksPelanggan(buildCustomerMessage(customer, a, ncfg), customer);
