...
const DEFAULT_PENANGANAN_LUAR_JAM =
    "Tim teknisi sudah dapat infonya 🙏 Karena sekarang di luar jam kerja, pengecekan ke lapangan " +
    "dimulai {waktu_mulai}. Kalau ternyata pulih lebih cepat, kami tetap kabari ya.";
...
const DEFAULT_PENANGANAN_LUAR_JAM_TANPA_WAKTU =
    "Tim teknisi sudah dapat infonya 🙏 Karena sekarang di luar jam kerja, penanganan ke lapangan " +
    "dilakukan pada jam kerja berikutnya. Kalau ternyata pulih lebih cepat, kami tetap kabari ya.";
...
function createLosBroadcaster(deps = {}) {
    ...
    function buildPenangananNote(ncfg) {
        const { dalamJamKerja, teks } = waktuMulaiKerjaBerikutnya();
        if (dalamJamKerja) {
