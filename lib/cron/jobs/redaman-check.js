        ...
        checkTask = cron.schedule(schedule, async () => {
            try {
                ...
                try {
                    ...
                    console.warn('[CRON_REDAMAN] Gagal baca sesi PPPoE aktif (lanjut tanpa MAC live):', e.message);
                }
                ...
                if (setelanLingkup.hanyaPelangganSendiri) {
                    ...
                    if (ditambahAreaSendiri > 0) {
                        console.log(`[CRON_REDAMAN_AREA] ${ditambahAreaSendiri} modem di area kita BELUM DIDAFTARKAN ikut dipantau `
                ...
                for (const device of devicesWithRedaman) {
                    ...
                    if (dua.bedaBesar) {
                        ...
                        devicesIntegritas++;
                        console.warn('[CRON_REDAMAN_BEDA_JAUH] ' + (device._id || '?')
                ...
                if (devicesDitambalOlt > 0 || devicesIntegritas > 0 || petaOlt) {
                    console.log('[CRON] Redaman sumber-ganda: ' + devicesDitambalOlt
