 ...
 */
"use strict";
const log = require('./logger').logger.child('SALDO_MANAGER');
...
function initDatabase() {
    try {
        ...
        initSaldoDatabase().catch(err => {
            log.error('[SALDO-MANAGER] Error initializing SQLite:', err);
        });
...
module.exports = {
    ...
    getUserSaldoData: balanceOperations.getUserSaldoData, // Row data atau null (cek eksistensi)
