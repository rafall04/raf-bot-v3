...
// Clean up expired attempts every hour. unref timer agar tidak menahan event loop
// di test/CLI script — produksi tetap jalan normal karena ada HTTP listener aktif.
const _otpCleanupInterval = setInterval(cleanupExpiredAttempts, 60 * 60 * 1000);
if (typeof _otpCleanupInterval.unref === 'function') {
