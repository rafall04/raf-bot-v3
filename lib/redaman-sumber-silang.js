 ...
 *
 *          AMBANG BEDA 2,5 dB — DIKALIBRASI, bukan ditebak. Percobaan pertama memakai 1,5 dB
 *          (di atas p90 = 1,02) dan langsung menandai 2 dari 97 perangkat yang pemetaannya
 *          BENAR. Sebaran per model menjelaskan kenapa: HG8145V5 (n=92) median 0,46 · p90
 *          0,93 · **maksimum 1,85 dB**. Jadi 1,5 memotong ekor sebaran yang wajar. 2,5 berada
 *          di atas maksimum terukur, sementara salah-petakan biasanya berselisih jauh lebih
 *          besar — armada ini terentang dari -9,57 s/d -30,46 dBm.
 *
 *          Beda di atas ambang berarti kita hampir pasti membandingkan DUA PERANGKAT BERBEDA:
