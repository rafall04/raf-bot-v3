...
function initializePhotoUploadCleanup() {
    if (cleanupInterval) {
        return cleanupInterval;
    }

    cleanupInterval = setInterval(cleanupOldSessions, 10 * 60 * 1000);
    return cleanupInterval;
}

function stopPhotoUploadCleanup() {
    if (!cleanupInterval) {
        return;
    }
