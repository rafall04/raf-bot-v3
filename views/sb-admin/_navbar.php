...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" aria-label="Navigasi cepat admin">
    ...
    <li class="nav-item <?php echo isParentActive(['/map-viewer', '/network-assets', '/statik', '/admin-olt', '/admin-olt-provision', '/olt-log', '/cctv-monitor', '/infra-monitor'], $current_page) ? 'active' : ''; ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseJaringan" aria-expanded="<?php echo isParentActive(['/map-viewer', '/network-assets', '/statik', '/admin-olt', '/admin-olt-provision', '/olt-log', '/cctv-monitor', '/infra-monitor'], $current_page) ? 'true' : 'false'; ?>" aria-controls="collapseJaringan">
            <i class="fas fa-fw fa-network-wired"></i>
            <span>Jaringan</span>
        </a>
        <div id="collapseJaringan" class="collapse <?php echo isParentActive(['/map-viewer', '/network-assets', '/statik', '/admin-olt', '/admin-olt-provision', '/olt-log', '/infra-monitor'], $current_page) ? 'show' : ''; ?>" aria-labelledby="headingJaringan" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
