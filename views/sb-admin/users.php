                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3"><label for="create_billing_cycle" class="form-label">Siklus Tagihan</label><select class="form-control form-control-sm" name="billing_cycle" id="create_billing_cycle"><option value="awal_bulan" selected>Awal bulan (standar)</option><option value="akhir_bulan">Akhir bulan</option></select><small class="form-text text-muted">Awal bulan: ditagih awal, isolir tanggal isolir standar. Akhir bulan: ditagih &amp; diisolir menjelang akhir bulan (untuk pelanggan yang sepakat bayar akhir bulan).</small></div>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3"><label for="edit_billing_cycle" class="form-label">Siklus Tagihan</label><select class="form-control form-control-sm" name="billing_cycle" id="edit_billing_cycle"><option value="awal_bulan">Awal bulan (standar)</option><option value="akhir_bulan">Akhir bulan</option></select><small class="form-text text-muted">Awal bulan: ditagih awal, isolir tanggal isolir standar. Akhir bulan: ditagih &amp; diisolir menjelang akhir bulan (untuk pelanggan yang sepakat bayar akhir bulan).</small></div>
                        </div>
                        <div class="col-md-6">
